...
public class Spike13 {
	...
	private static void createAndShowGUI() {
		...
		int screen = Spike13.DESIRED_SCREEN;
		...
		HyperspaceInteractionPanel hip = new HyperspaceInteractionPanel(rect.width,rect.height);
		frame.getContentPane().add(hip); // BorderLayout center
