...
public class BasicSlideNotes extends EventAwareVO implements Slide, OIOAble {
    ...
    /**
     * The notes slide associated with this slide, if any
     */
    @OIO(owned = false)
    private VO mNotesSlide = null;
    ...
    public boolean handleKeyboardEventHere(KeyboardEventInfo kei) {
        if (isMouseTarget()) {
            ...
            System.out.println("BasicSlide hKEH "+ke.getKeyChar() + kei);
