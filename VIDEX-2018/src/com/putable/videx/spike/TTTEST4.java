...
import com.putable.videx.core.oio.load.AST.ASTNode;
import com.putable.videx.core.oio.load.AST.ASTTree;

public class TTTEST4 {
    ...
    public static void main(String[] args ) {
        ...
        OIOCompiler compiler = new OIOCompiler("/home/ackley/SLIDEDECK_BUT_NO_I_ROTTED",null,null);
        //compiler.reload();
        ASTNode tree = new ASTTree();//BECAUSE I ROTTED SO NOT: compiler.getSlideDeck();
